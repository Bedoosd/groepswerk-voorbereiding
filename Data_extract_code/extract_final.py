...
import os
cwd = os.getcwd()
euro_summary = Path.cwd().parent / "Data" / "Euro" / "euro_summary.csv"
world_cup_summary = Path.cwd().parent / "Data" / "World" / "world_cup.csv"


with open (euro_summary, "r") as f:
    csv_euro = csv.reader(f)
    euro_winner_year = {}
    next(csv_euro) #skip header
    for row in csv_euro:
...
with open (world_cup_summary, "r") as f:
